...
// end of name constraints
    ...
    // load ee
    if ( gnutls_x509_crt_import(certlist[0], &d0, GNUTLS_X509_FMT_DER) < GNUTLS_E_SUCCESS ) {
        printf("Leaf cert import err");
        return 1;
    }

    unsigned int ret_1 = gnutls_x509_crt_check_hostname(certlist[0], name);
    printf("ret val 1: %u\n", ret_1);

    unsigned int ret_2 = gnutls_x509_crt_check_hostname2(certlist[0], name, 0);
    printf("ret val 2: %u\n", ret_2);
